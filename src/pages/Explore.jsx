...
export default function Explore() {
  return (
    <main className="min-h-screen" style={{ background: 'transparent' }}>
      ...
      <div
        className="relative max-w-5xl mx-auto px-4 sm:px-6 md:px-10 text-center"
        style={{ paddingTop: 'clamp(80px,10vw,140px)', paddingBottom: '40px' }}
      >
        <motion.span
          initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
          className="section-label mb-6 sm:mb-8 inline-block"
        >
          Discovery
        </motion.span>
        ...
        <motion.h1
          ...
          className="font-heading text-gray-900 leading-none tracking-tight text-balance mb-4 sm:mb-5"
        ...
        <motion.p
          ...
          style={{ fontSize: 'clamp(0.9rem,2.5vw,1.125rem)', lineHeight: '1.5', fontWeight: 400, color: 'rgba(15,15,15,0.52)' }}
        >
        ...
        <motion.div
          ...
          className="grid md:grid-cols-2 gap-4 sm:gap-5 max-w-3xl mx-auto text-left"
        >
          {/* Organizations */}
          <Link
            to="/organizations"
            className="group relative rounded-2xl p-5 sm:p-8 hover:-translate-y-1 transition-all duration-300 overflow-hidden"
            style={{
          ...
          >
            ...
            <h2 className="font-heading text-gray-900 mb-2 tracking-tight"
              style={{ fontSize: 'clamp(1rem,2.5vw,1.125rem)', lineHeight: '1.5', fontWeight: 600 }}>
              Organizations
            </h2>
          ...
          <Link
            to="/events"
            className="group relative bg-gray-900 rounded-2xl p-5 sm:p-8 hover:-translate-y-1 transition-all duration-300 overflow-hidden"
          ...
          >
            ...
            <h2 className="font-heading text-white mb-2 tracking-tight"
              style={{ fontSize: 'clamp(1rem,2.5vw,1.125rem)', lineHeight: '1.5', fontWeight: 600 }}>
              Events
            </h2>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8 sm:mt-12"
        >
